...
/*
 * Входные параметры расчёта малых продольных возмущений.
 *
 * Номинальный режим задаётся так же, как в основном C API:
 *
 * - objectId;
 * - releaseAltitudeM;
 * - releaseSpeedMps.
 *
 * Начальный вектор возмущений:
 *
 * Delta x0 =
 * [Delta V,
 *  Delta Theta,
 ...
 *
 * Delta alpha = Delta theta - Delta Theta.
 */
